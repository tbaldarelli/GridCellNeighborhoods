...
- [x] 11. Choose next language for implementation
...
- [x] 12. Implement chosen language version
...
- [x] 12.1 Write property tests for chosen language
...
- [x] 12.2 Write BDD scenario tests for chosen language
